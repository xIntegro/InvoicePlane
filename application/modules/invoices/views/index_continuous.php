<div id="headerbar">
    <h1><?php echo lang('continuous_invoices'); ?></h1>

    <div class="pull-right">
        <?php echo pager(site_url('invoices/continuous/index'), 'mdl_continuous_continuous'); ?>
    </div>
</div>
    ...
    <div id="filter_results">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                <?php foreach ($continuous_invoices as $invoice) { ?>
                    <tr>
                        <td>
                        <span class="label
                        ...
                        <td>
                        <td>
                            <?php echo date_from_mysql($invoice->notes_one); ?><br />
                            <?php echo date_from_mysql($invoice->notes_two); ?>
                        </td>
                        <td>
                            <div class="options btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo site_url('invoices/continuous/stop/' . $invoice->invoice_continuous_id); ?>">
                                            <i class="fa fa-ban fa-margin"></i> <?php echo lang('stop'); ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('invoices/continuous/delete/' . $invoice->invoice_continuous_id); ?>"
