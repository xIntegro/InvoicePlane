                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="first_name" value="<?php echo $record[0]['first_name']?>" class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="Fax" class="form-control" value="<?php echo $record[0]['fax']?>">
                                </div>
                            </div>
