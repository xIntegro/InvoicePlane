# Solves IP-195
ALTER TABLE `xc_quotes` ADD COLUMN `notes` LONGTEXT;
...
# Solves IP-227
ALTER TABLE `xc_invoices` CHANGE `invoice_number` `invoice_number` VARCHAR(100) NOT NULL;
ALTER TABLE `xc_quotes` CHANGE `quote_number` `quote_number` VARCHAR(100) NOT NULL;