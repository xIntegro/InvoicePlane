...
ALTER TABLE `xc_invoice_item_amounts`
ADD COLUMN `item_discount` DECIMAL(20, 2) NOT NULL DEFAULT 0
AFTER `item_tax_total`;
ALTER TABLE `xc_invoice_items`
ADD COLUMN `item_discount_amount` DECIMAL(20, 2) NOT NULL DEFAULT 0
AFTER `item_price`;

# Feature IP-162
# For module "projects" 
CREATE TABLE `xc_projects` (
...
ALTER TABLE xc_invoice_item_amounts MODIFY COLUMN item_subtotal DECIMAL(20, 2);
ALTER TABLE xc_invoice_item_amounts MODIFY COLUMN item_tax_total DECIMAL(20, 2);
ALTER TABLE xc_invoice_item_amounts MODIFY COLUMN item_total DECIMAL(20, 2);
ALTER TABLE xc_quote_item_amounts MODIFY COLUMN item_subtotal DECIMAL(20, 2);
ALTER TABLE xc_quote_item_amounts MODIFY COLUMN item_tax_total DECIMAL(20, 2);
ALTER TABLE xc_quote_item_amounts MODIFY COLUMN item_total DECIMAL(20, 2);
